  ...
  ...tseslint.configs.strictTypeChecked,
  {
    ...
    settings: {
      'boundaries/elements': [
        ...
        { type: 'resolve',    pattern: 'src/resolve/**' },
        { type: 'jsresolve',  pattern: 'src/jsresolve/**' },
    ...
    rules: {
      ...
      'boundaries/element-types': ['error', {
        ...
        rules: [
          ...
          { from: 'resolve',    allow: ['resolve', 'store', 'anchors', 'facts', 'foundation', 'derive'] },
          { from: 'jsresolve',  allow: ['jsresolve', 'store', 'facts', 'anchors', 'foundation', 'extract', 'derive'] },
          ...
          { from: 'build',      allow: ['build', 'discover', 'extract', 'derive', 'store', 'config', 'foundation', 'facts', 'anchors', 'jsresolve'] },
          { from: 'cli',        allow: ['cli', 'config', 'store', 'anchors', 'query', 'emit', 'foundation', 'build', 'discover', 'resolve'] },
