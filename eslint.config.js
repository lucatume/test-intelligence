    ...
    rules: {
      ...
      'boundaries/element-types': ['error', {
        ...
        rules: [
          ...
          { from: 'clock',     disallow: ['paths', 'ids', 'errors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'paths',     disallow: ['ids', 'errors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'ids',       disallow: ['errors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
