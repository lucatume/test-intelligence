    ...
    rules: {
      ...
      'boundaries/element-types': ['error', {
        ...
        rules: [
          ...
          { from: 'result',    disallow: ['parse', 'types', 'clock', 'paths', 'ids', 'errors', 'anchors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'parse',     disallow: ['types', 'clock', 'paths', 'ids', 'errors', 'anchors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'types',     disallow: ['clock', 'paths', 'ids', 'errors', 'anchors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'clock',     disallow: ['paths', 'ids', 'errors', 'anchors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'paths',     disallow: ['ids', 'errors', 'anchors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'ids',       disallow: ['errors', 'anchors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'errors',    disallow: ['anchors', 'config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
          { from: 'anchors',   disallow: ['config', 'storage', 'query', 'emit', 'cli', 'cli-entry'] },
